...
from gqlforge.naming import method_name_for_operation
from gqlforge.operations import load_operations
...
def test_availability_manifest_matches_generated_map():
    ...
    manifest = json.loads(CONFIG.availability_path.read_text(encoding="utf-8"))
